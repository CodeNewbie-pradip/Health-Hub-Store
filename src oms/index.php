...
?>
  ...
  <main>
    ...
    <!-- Main -->
    <div class="wrapper">
            <h1>BEST MEDICINE AND ALL TYPES MEDICINE<h1>
    ...
    <footer class="page-footer">
        ...
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Shelar Nitin <br>
				    ...
				    Kakade Dinesh<br>
				    Nibhore Swapnil<br>
			    	Indira Gandhi Polytechnic, Belwndi(Suagar)
          </address>
            <div class="phone">
              Telephone:
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> @2022 NPD Medicia&trade;
          </div>

          <div class="developer">
            Developed by<br>
				Labade.P.A, Shelar.N.D, Kakde.D.D, Nimbhore.S.S
          </div>
        </div>
      </div>
    </footer>
